...
pixi add gds-tools libcufile libcufile-dev libcufile-static
# for installing globally
pixi global install gds-tools libcufile libcufile-dev libcufile-static
```
...
It is possible to list all of the versions of `gds-tools` available on your platform:
...
```
pixi search gds-tools --channel conda-forge
```
